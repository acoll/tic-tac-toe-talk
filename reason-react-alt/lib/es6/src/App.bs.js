...
function make() {
  return /* record */[
          ...
          /* render */(function () {
              return ReasonReact.element(/* None */0, /* None */0, GameState$ReactTemplate.make((function (board, player, gameState, placeMarker, playerToString, reset) {
                                return ReasonReact.element(/* None */0, /* None */0, Fragment$ReactTemplate.make(/* array */[
                                                typeof gameState === "number" ? (
                                                    gameState !== 0 ? React.createElement("header", {
                                                            className: "active"
                                                          }, "Tie Game") : React.createElement("header", undefined, Curry._1(playerToString, player) + "'s Turn")
                                                  ) : React.createElement("header", {
                                                        className: "active"
                                                      }, Curry._1(playerToString, gameState[0]) + " won!"),
